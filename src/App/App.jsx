...
class App extends React.Component {
  ...
  inputEPowerX = () => {
    const value = parseFloat(this.state.displayValue);
    this.setState({
      displayValue: String(this.power(Math.E, value))
    });
  };
    ...
    return (
      <div>
        ...
        <div className={style.numberFields}>
          ...
          <button onClick={() => this.inputPi()}>Pi</button>
          <button onClick={() => this.inputSqrt()}>sqrt</button>
          <button onClick={() => this.inputEPowerX()}>e^x</button>
        </div>
        <div className={style.operations}>
